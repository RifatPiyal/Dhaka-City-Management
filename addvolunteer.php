<?php
    ...
    $result="";
      //insert query
        if(isset($_POST['add_data'])){
            ...
            $insert_sql= "INSERT INTO volunteer_info (vfirst_name,vlast_name,vage,vemail,vgender,vpass) values ('$fname','$lname',$age,'$email','$gender','$pass')";
    ...
    $select_sql="SELECT * FROM volunteer_info";
                        ...
                        <div class="navigation ">
                            <nav>
                                <ul class="sf-menu">
                                    ...
                                    <li class="current"><a href="signup.php">Be A donar</a></li>
            ...
            <div class="inner">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="Volunteer Name" name="student_fname" class="form-control" required>
                    ...
                    <div class="form-wrapper">
                        <input type="number" placeholder="Phone Number" name="student_pass" class="form-control" required>
