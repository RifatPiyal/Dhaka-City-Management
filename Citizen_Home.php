      ...
      <h3>Enter Information</h3>
                <?php
                  if(isset($_POST['apfullname'])){
                    ...
                    appointment_booking($i, $_POST['apSpecialist'], $_POST['apCondition'],$_POST['DrName']);
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <h2>Select Doctor</h2>
            <select class='form-control' required value=1 name="DrName">

            <?php 
                $result = getListOfName('doctors');
